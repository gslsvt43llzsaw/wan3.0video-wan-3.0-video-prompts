# Wan 3.0 Video API (wan-3.0-video / wan3.0video) — prompts guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-55d0dd)** · **[Get an API key](https://go.apimart.ai/k-490721)**
